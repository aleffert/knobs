#
#  Be sure to run `pod spec lint Knobs.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLE/Knobs" #FIXME
  ...
  # s.authors          = { "Akiva Leffert" => "akiva@etsy.com", "other author" => "email@address.com" }
  # s.author           = 'Akiva Leffert', 'other author'
  # s.social_media_url = "http://twitter.com/Akiva Leffert"
  ...
  s.source       = { :git => "https://github.com/aleffert/knobs.git", :branch => "master" }
  ...
  s.exclude_files = 'Libraries/NSData_Base64/base64.m'
